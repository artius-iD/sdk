...
The SDK supports complete branding control by allowing you to override any SDK image with your own branding. For comprehensive documentation on image customization, see **[THEMING_GUIDE.md](THEMING_GUIDE.md#-image-overrides)**.
...
let imageOverrides = SDKImageOverrides(
    ...
    successIcon: UIImage(named: "CustomCheck"),
    faceOverlay: UIImage(named: "CustomFaceFrame"),
    enableFallback: true
)
ImageOverrideManager.shared.setConfiguration(imageOverrides)
```

See the [Image Overrides section in THEMING_GUIDE.md](THEMING_GUIDE.md#-image-overrides) for:
- Complete list of overridable images
